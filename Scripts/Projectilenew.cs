...
public partial class Projectilenew : CharacterBody2D
{
	...
	private KinematicCollision2D LastRegisteredCollision;
	...
	public override void _Process(double delta)
	{
		...
		if (projectileActive == true)
		{
			...
			if (GetLastSlideCollision() != null && GetLastSlideCollision() != LastRegisteredCollision)
			{
				LastRegisteredCollision = GetLastSlideCollision();
				_on_body_entered(new StaticBody2D());
			}
		}
